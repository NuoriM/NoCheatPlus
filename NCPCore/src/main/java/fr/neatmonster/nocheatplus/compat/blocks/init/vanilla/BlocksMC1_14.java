...
public class BlocksMC1_14 implements BlockPropertiesSetup {
    ...
    public void setupBlockProperties(WorldConfigProvider<?> worldConfigProvider) {
        ...
        final long wall = BlockProperties.F_VARIABLE | BlockProperties.F_GROUND | BlockProperties.F_HEIGHT150 | BlockProperties.F_THICK_WALL;
        ...
        BlockFlags.addFlags("LECTERN", BlockProperties.F_MIN_HEIGHT8_1);
        BlockFlags.addFlags("LECTERN", BlockProperties.F_GROUND_HEIGHT);
        BlockFlags.addFlags("LECTERN", BlockProperties.F_GROUND);
        ...
        BlockInit.setAs("STONECUTTER", Material.BRICK_SLAB);
        BlockFlags.addFlags("STONECUTTER", BlockProperties.F_MIN_HEIGHT16_9);
        BlockFlags.addFlags("STONECUTTER", BlockProperties.F_GROUND_HEIGHT);
        ...
        BlockFlags.addFlags("BAMBOO", BlockProperties.F_IGN_PASSABLE | BlockProperties.F_GROUND | BlockProperties.F_GROUND_HEIGHT | BlockProperties.F_THIN_FENCE);
        ...
        BlockInit.setAs("ACACIA_WALL_SIGN", BridgeMaterial.WALL_SIGN);
        BlockInit.setAs("BIRCH_SIGN", BridgeMaterial.SIGN);
        BlockInit.setAs("BIRCH_WALL_SIGN", BridgeMaterial.WALL_SIGN);
        BlockInit.setAs("DARK_OAK_SIGN", BridgeMaterial.SIGN);
        BlockInit.setAs("DARK_OAK_WALL_SIGN", BridgeMaterial.WALL_SIGN);
        BlockInit.setAs("JUNGLE_SIGN", BridgeMaterial.SIGN);
        BlockInit.setAs("JUNGLE_WALL_SIGN", BridgeMaterial.WALL_SIGN);
        BlockInit.setAs("OAK_SIGN", BridgeMaterial.SIGN);
        BlockInit.setAs("OAK_WALL_SIGN", BridgeMaterial.WALL_SIGN);
        BlockInit.setAs("SPRUCE_SIGN", BridgeMaterial.SIGN);
        BlockInit.setAs("SPRUCE_WALL_SIGN", BridgeMaterial.WALL_SIGN);
